...
class AppliPendule(tk.Tk):
    ...
    def __init__(self, l=2e-2, thetadeb=170, alpha=0, f=51, a=2e-3, g=9.81, 
                 tau=1, N=100000, tfin=10):
        ...
        self.theta = 0.25* np.pi  # angle du pendule
        self.dtheta = 0.0  # vitesse angulaire ,le pend.ule est au repos au début
